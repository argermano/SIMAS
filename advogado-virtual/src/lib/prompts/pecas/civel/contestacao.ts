...
export function buildPromptContestacaoCivel(dados: {
  ...
  return `
Você é um advogado civilista experiente redigindo uma Contestação Cível.
...
4. Preliminares (prescrição, decadência, inépcia, ilegitimidade, falta de interesse processual)
...
- Fundamente com artigos do CC/2002, CPC/2015 e CF/88
...
export const SYSTEM_CONTESTACAO_CIVEL = `Você é um advogado civilista sênior redigindo peças de defesa cíveis. Escreva a peça COMPLETA em Markdown bem formatado, com linguagem jurídica formal. NUNCA interrompa a geração — sempre conclua a peça inteira. ${SYSTEM_REGRAS_FORENSE}`
